...
$select_1 = "SELECT * FROM songs ORDER BY RAND(time_to_sec(current_time()) / 300)  LIMIT 18";
...
<div class="iq-card-header">
    <div class="iq-header-title">
         ...
         <div class="container-fluid">
                ...
                <h1 class="h111"><span class='one'>LATEST s</span><span class='two'>o</span><span class='three'>n</span><span class='four'>g</span><span class='five'>s</span><span class='six'></span></h1>
               </div>
...
<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
    <div class="container" style="height: 500px; background-color: black; border-radius: 40px;">
        <div class="lamp_card">
            <img src="images/newicon.png" style="margin-left: -80px; margin-top: 5px;" height="30px" width="100px" alt="">
            <a href="playsong.php?id=<?php echo $row["id"] ?>"><img src="../admin2/pages/songimage/<?php echo $row["image"] ?>" style="border-radius: 20px; margin-top: 10px; width: 100%; height: 260px;" alt="sm-chair"></a>
            <div style="height: 80px;">
            <h1 class="title text-center">
                <?php 
                    $maxLength = 25; // Set your desired character limit
                    $title = $row["title"];
                    echo (strlen($title) > $maxLength) ? substr($title, 0, $maxLength) . '...' : $title;
                ?>
            </h1>
