                        ...
                        <form action="songs.php" method="GET">
                            <div class="row iq-card-header d-flex justify-content-center">
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 mt-2 mb-2 text-center">
                                    <select class="button-13" style="width: 150px; height: 50px;" name="search" id="" value="<?php if (isset($_GET['search'])) {
                                                                                                                                    echo $_GET['search'];
                                                                                                                                } ?>">
                ...
                <div class="iq-card-header">
                    <div class="iq-header-title">
                        ...
                        <div class="container-fluid">
                            ...
                            <h1 class="h111"><span class='one'>s</span><span class='two'>o</span><span class='three'>n</span><span class='four'>g</span><span class='five'>s</span><span class='six'></span></h1>
                        </div>
                    ...
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_assoc($select_run_1)) { ?>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                                <div class="container" style="height: 450px; background-color: black; border-radius: 40px;">
                                    <div class="lamp_card">
                                        <a href="playsong.php?id=<?php echo $row["id"] ?>"><img src="../admin2/pages/songimage/<?php echo $row["image"] ?>" style="border-radius: 20px; margin-top: 10px; width: 100%; height: 220px;" alt="sm-chair"></a>
