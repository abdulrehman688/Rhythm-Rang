...
<div class="iq-card-header">
    <div class="iq-header-title">
         ...
         <div class="container-fluid">
             ...
             <h1 class="h111"><span class='one'>a</span><span class='two'>r</span><span class='three'>t</span><span class='four'>i</span><span class='five'>s</span><span class='six'>ts</span></h1>
            </div>
...
<div class="iq-card-body p-0" style="width: 220px;">
<div class="iq-thumb">
    <div class="iq-music-overlay"></div>
    <a href ="showartist.php?id=<?php echo $row["id"] ?>">
        <img style="border-radius: 250px; height: 220px;" src="../admin2/pages/artistimage/<?php echo $row["image"] ?>" class="img-border-radius img-fluid w-100" alt="">
    </a>
