...
echo "";
        ...
        <div class="row g-0">
            ...
            <div class="card-body">
                ...
                <p class="card-text" style="background-color: black; width: 100px; height: 50px; border-radius: 20px;">
                <a href="playsong.php?id=<?php echo $row["id"] ?>"><i class="fas fa-play text-light" style="margin: 13px 15px 15px 40px; font-size: x-large;"></i></a> 
                </p>
            </div>
            </div>
        </div>
